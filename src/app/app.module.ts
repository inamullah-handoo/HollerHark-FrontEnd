...
const appRoutes: Routes = [
  ...
  {path: 'admin/userList/:role', component: ViewUserListComponent, canActivate: [AuthGuard]},
  {path: 'admin/user/:id', component: ViewUserDetailsComponent, canActivate: [AuthGuard]},
  {path: 'admin/dean/register', component: DeanRegisterComponent, canActivate: [AuthGuard]},
  {path: 'complaint/register', component: ComplaintRegisterComponent, canActivate: [AuthGuard]},
  {path: 'complaint/list/:params', component: ViewComplaintListComponent, canActivate: [AuthGuard]},
  {path: 'complaint/view/:id', component: ViewComplaintComponent, canActivate: [AuthGuard]},
  {path: '**', redirectTo: '/'}
];
